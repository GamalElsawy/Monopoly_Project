...
public class Main extends Application {
    ...
    static Dimension sR = Toolkit.getDefaultToolkit().getScreenSize();
    public static double x = sR.getWidth() / 1920, y = sR.getHeight() / 1080;
    protected static Box Player = new Box( x(30),  y(30), 30);
    protected static Sphere Player2 = new Sphere(x(20));
    protected static Cylinder Player3 = new Cylinder(x(15), y(30));
    protected static Box Player4 = new Box(25 * x, 40 * y, 40);
    ...
    public void start(Stage PrimaryStage) throws Exception {
        ...
        Player.translateXProperty().set(914 * x);
        Player.translateYProperty().set(783 * y);

        Player2.setMaterial(Playermaterial2);
        Player2.translateXProperty().set(914 * x);
        Player2.translateYProperty().set(846 * y);

        Player3.setMaterial(Playermaterial3);
        Player3.translateXProperty().set(944 * x);
        Player3.translateYProperty().set(829 * y);

        Player4.setMaterial(Playermaterial4);
        Player4.translateXProperty().set(944 * x);
        Player4.translateYProperty().set(765 * y);
        ...
        ImageView im = new ImageView(new Image(getClass().getResourceAsStream("/sample/xyz.png")));
        im.setFitWidth(1500 * sR.getWidth() / 1920);
        ...
        throwDice.translateXProperty().set(300 * x);
        throwDice.translateYProperty().set(900 * y);
        ...
        throwDice.setMinWidth(30 * x);

        endTurn.setTranslateX(300 * x + 400);
        endTurn.setTranslateY(900 * y);
        ...
        endTurn.setMinWidth(30 * x);
        group.getChildren().add(endTurn);

        dec.setTranslateX(300 * x + 175);
        dec.setTranslateY(900 * y + 20);
        dec.setMinWidth(dec.getMinWidth() * x);
    ...
    public static double x (double num){
        return num * sR.getWidth() / 1920;
    }
    public static double y (double num){
        return num * sR.getHeight() / 1080;
    }
    ...
    public static void moveFirst(int DiceRoll, int turn, int d1, int d2) {
        ...
        if (turn == 0) {
            ...
            box[turn].translateXProperty().set(gameData.Path1.get(gameData.cur1).x * x);
            box[turn].translateYProperty().set(gameData.Path1.get(gameData.cur1).y * y);
        ...
        if (turn == 1) {
            ...
            box[turn].translateXProperty().set(gameData.Path2.get(gameData.cur2).x * x);
            box[turn].translateYProperty().set(gameData.Path2.get(gameData.cur2).y * y);
        ...
        if (turn == 2) {
            ...
            box[turn].translateXProperty().set(gameData.Path3.get(gameData.cur3).x * x);
            box[turn].translateYProperty().set(gameData.Path3.get(gameData.cur3).y * y);
        ...
        if (turn == 3) {
            ...
            box[turn].translateXProperty().set(gameData.Path4.get(gameData.cur4).x * x);
            box[turn].translateYProperty().set(gameData.Path4.get(gameData.cur4).y * y);
